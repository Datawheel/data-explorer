...
var tesseractExplorer = require('@datawheel/tesseract-explorer');
...
init_cjs_shims();
var ErrorBoundary = class extends React2__default.default.Component {
  constructor() {
    super(...arguments);
    this.state = {
      message: "",
  ...
  render() {
    ...
    return /* @__PURE__ */ React2__default.default.createElement(tesseractExplorer.TranslationConsumer, null, ({ translate: t }) => {
      const detailText = t("error.detail");
      return /* @__PURE__ */ React2__default.default.createElement(core.Flex, { p: "xl", align: "center", justify: "center", direction: "column", className: "chart-card error" }, /* @__PURE__ */ React2__default.default.createElement(core.Title, { order: 3 }, t("error.title")), detailText.length ? /* @__PURE__ */ React2__default.default.createElement(core.Text, null, detailText) : null, /* @__PURE__ */ React2__default.default.createElement(core.Text, null, t("error.message", { message })), /* @__PURE__ */ React2__default.default.createElement(core.Group, { spacing: "xs", my: "sm" }, /* @__PURE__ */ React2__default.default.createElement(
        core.Button,
        {
        ...
        t("action_retry")
      ), /* @__PURE__ */ React2__default.default.createElement(core.Button, { error: name, message })));
    });
  }
};
...
// src/components/ChartCard.tsx
var chartComponents = {
  barchart: d3plusReact.BarChart,
  barchartyear: d3plusReact.BarChart,
  donut: d3plusReact.Donut,
  geomap: d3plusReact.Geomap,
  histogram: d3plusReact.BarChart,
  lineplot: d3plusReact.LinePlot,
  pie: d3plusReact.Pie,
  stacked: d3plusReact.StackedArea,
  treemap: d3plusReact.Treemap
};
var iconByFormat = {
...
function ChartCard(props) {
  ...
  const { translate, locale } = tesseractExplorer.useTranslation();
  const nodeRef = React2.useRef(null);
  const ChartComponent = chartComponents[chart.chartType];
  const config = React2.useMemo(() => vizbuilder.createChartConfig(chart, {
    currentChart,
    isSingleChart,
  ...
  const downloadButtons = React2.useMemo(() => {
    ...
    return asArray(props.downloadFormats).map((format) => {
      ...
      return /* @__PURE__ */ React2__default.default.createElement(
        core.Button,
        {
          compact: true,
          key: format,
          leftIcon: /* @__PURE__ */ React2__default.default.createElement(Icon, { size: 16 }),
          onClick: () => {
  ...
  const focusButton = React2.useMemo(() => {
    if (!isFocused && isSingleChart)
      return null;
    const Icon = isFocused ? iconsReact.IconArrowsMinimize : iconsReact.IconArrowsMaximize;
    return /* @__PURE__ */ React2__default.default.createElement(
      core.Button,
      {
        compact: true,
  ...
  return /* @__PURE__ */ React2__default.default.createElement(core.Paper, { h: height, w: "100%", style: { overflow: "hidden" } }, /* @__PURE__ */ React2__default.default.createElement(ErrorBoundary, null, /* @__PURE__ */ React2__default.default.createElement(core.Stack, { spacing: 0, h: height, style: { position: "relative" }, w: "100%" }, /* @__PURE__ */ React2__default.default.createElement(core.Group, { position: "right", p: "xs", spacing: "xs", align: "center" }, downloadButtons, focusButton), /* @__PURE__ */ React2__default.default.createElement(core.Box, { style: { flex: "1 1 auto" }, ref: nodeRef, pb: "xs", px: "xs" }, /* @__PURE__ */ React2__default.default.createElement(ChartComponent, { config })))));
}
...
function createVizbuilderView(settings) {
  ...
  function VizbuilderView(props) {
    ...
    const { actions, formatters } = tesseractExplorer.useSettings();
    const [panelName, currentChart] = React2.useMemo(() => `${panelKey || ""}-`.split("-"), [panelKey]);
    const resetCurrentPanel = React2.useCallback(() => {
      actions.switchPanel(panelName);
    }, [panelName]);
    const charts = React2.useMemo(() => vizbuilder.generateCharts([{
      cube,
      dataset: result.data,
      params: {
    ...
    const content = React2.useMemo(() => {
      ...
      if (filteredCharts.length === 0)
        return /* @__PURE__ */ React2__default.default.createElement(Notice, null);
      return /* @__PURE__ */ React2__default.default.createElement(
        core.SimpleGrid,
        {
          breakpoints: [
        ...
        filteredCharts.map(
          (chart) => /* @__PURE__ */ React2__default.default.createElement(
            ChartCard,
            {
              chart,
              currentChart: "",
    ...
    const focusContent = React2.useMemo(() => {
    ...
    return /* @__PURE__ */ React2__default.default.createElement(core.Box, { className: props.className, p: "sm" }, content, /* @__PURE__ */ React2__default.default.createElement(
      core.Modal,
      {
        centered: true,
...
function NonIdealState() {
  const { translate: t } = tesseractExplorer.useTranslation();
  return /* @__PURE__ */ React2__default.default.createElement(core.Box, { className: "vizbuilder-nonidealstate" }, /* @__PURE__ */ React2__default.default.createElement(core.Title, { order: 1, className: "vizbuilder-nonidealstate-header" }, t("nonidealstate_msg")));
}
...
exports.createVizbuilderView = createVizbuilderView;
